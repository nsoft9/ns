...
<body>
	...
	<section id="container">
		<h2><b>Expenditure Values Processing</b></h2>
		<form:form method="POST" modelAttribute="expendValues">
		<div style="text-align:center;">
		<span>
		<h3>Enter Expenditure Type:</h3>
		<input type="text" name="expenditureType" id="selmenu" style="width:250px">
      	</span>
      	<input type="submit" class="w3-btn w3-ripple w3-metro-magenta w3-round" value="Add">
      	</div>
      	<a href="/addExpenses" style="font-color:blue"><h3>Back</h3></a>
	</form:form>
	
	<c:if test="${not empty failureMessage}">
    	<div id="serverError" class="alert alert-danger">
        <a href="/addvalues" class = "close" data-dismiss="alert">&times;</a>
