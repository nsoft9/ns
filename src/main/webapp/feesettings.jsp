...
<head>
	...
	<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
  	...
  	<link rel="stylesheet" media="screen and (min-height: 501px)" href="css/fixedfooter.css">
	<link rel="stylesheet" media="screen and (max-height: 500px)" href="css/footer.css">
...
<table id="cust" style="text-align:center">
	...
	<section id="container">
		<h2><b>Default Fee Settings</b></h2>
		<form:form method="POST" modelAttribute="expensesForm">
		
		<table id="cust">
			<tr>
			<td><h3>Tution Fee Term Division:</h3></td>
			<td>
				<span class="radiobadge">
						<input type="radio" id="low" name="tutionfeetermdivflag" value="Y" <c:if test="${mycodes.tutionfeetermdivflag=='1'}">checked</c:if>>
						<label for="low"><h3>Yes</h3></label>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="radio" id="med" name="tutionfeetermdivflag" value="N"  <c:if test="${mycodes.tutionfeetermdivflag=='0'}">checked</c:if>>
						<label for="med"><h3>No</h3></label>
				</span>
			</td>
      		</tr>
      
      		<tr>
			<td><h3>Fetch Default Fee from Database:</h3></td>
			<td>
				<span class="radiobadge">
						<input type="radio" id="low" name="fetchfeefromdb" value="Y" <c:if test="${mycodes.fetchfeefromdb=='1'}">checked</c:if>>
						<label for="low"><h3>Yes</h3></label>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="radio" id="med" name="fetchfeefromdb" value="N"  <c:if test="${mycodes.fetchfeefromdb=='0'}">checked</c:if>>
						<label for="med"><h3>No</h3></label>
				</span>
			</td>
			</tr>
			...
			<tr>
			<td><h3>Hostel Fee Enable:</h3></td>
			<td>
				<span class="radiobadge">
						<input type="radio" id="low" name="hostelfeeenableflag" value="Y" <c:if test="${mycodes.hostelfeeenableflag=='1'}">checked</c:if>>
						<label for="low"><h3>Yes</h3></label>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="radio" id="med" name="hostelfeeenableflag" value="N"  <c:if test="${mycodes.hostelfeeenableflag=='0'}">checked</c:if>>
						<label for="med"><h3>No</h3></label>
				</span>
			</td>
			</tr>
			...
			<tr>
			<td><h3>Bus Fee Term Division:</h3></td>
			<td>
				<span class="radiobadge">
						<input type="radio" id="low" name="busfeetermdivflag" value="Y" <c:if test="${mycodes.busfeetermdivflag=='1'}">checked</c:if>>
						<label for="low"><h3>Yes</h3></label>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="radio" id="med" name="busfeetermdivflag" value="N"  <c:if test="${mycodes.busfeetermdivflag=='0'}">checked</c:if>>
						<label for="med"><h3>No</h3></label>
				</span>
			</td>
			</tr>				
