...
<body>
	...
	<section id="container">
		...
		<table id="cust">
			<tr>
			<td><h3>Select Expenditure:</h3></td>
			<td>
			<select id="selmenu" name="expenditureType" tabindex="1" class="chosen" style="width:200px">
  			<option value=""></option>
            ...
            <option value="${myval.expenditureType}">${myval.expenditureType}</option>
      		...
      		<td>
      		<a href="/addvalues"><h3>Add Values</h3></a></td></tr>
      
      		<tr>
			<td><h3>Expenditure SubType:</h3></td>
			<td>
			<input type="text" name="expenditureSubtype" class="selmenu" style="width:200px"></td>
			</tr>
			
			<tr>
      		<td><h3>SELECT DATE:</h3></td>
      		<td>
			<input type="text" id="datepicker" name="expenditureDate" class="selmenu" placeholder="MM/DD/YYYY"></td></tr>
			
			<tr><td>
      		<h3>Amount:</h3></td>
      		<td><input type="text" name="expenditureAmount" class="selmenu"></td>
			<td>
			<h3>Amount Handed To:</h3></td>
			<td>
			<input type="text" name="expenditureamountHandedto" class="selmenu" style="width:200px"></td>
      	</table>
