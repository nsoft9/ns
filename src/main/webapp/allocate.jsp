...
<table id="cust" style="text-align:center">
	...
	<section id="container">
		<h2><b>Allocate access to User Settings</b></h2>
		<form:form method="POST" modelAttribute="uservalues">
		...
		<table id="cust">
			...
			<td><h3>Allow Admin Access:</h3></td>
				<td>
					<h3 style="color:blue">${myval.username}</h3>
					<select id="selmenu" name="username" tabindex="1" class="chosen" style="width:200px">
     					<c:forEach items="${users}" var="myval">
           				<option value="${myval.username}">${myval.username}</option>
            			</c:forEach>
      				</select>
				</td>
				<td>
				<div class="onoffswitch">
				<input type="checkbox" name="adminaccess" class="onoffswitch-checkbox" id="myonoffswitch">
				...
				<td>
				<h3><a href="/access" style="color:blue"><i>View</i></a></h3>
			</td>
			</tr>
