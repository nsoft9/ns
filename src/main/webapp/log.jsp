	...
	<td>User Loged In:<span class="rainbow">${username}</span></td> 
		...
		<section id="container">
			...
			<section id="aligned">
				...
				<h3>Contact:</h3>
				<input type="text" name="stuCont1" placeholder="Mobile No.." autocomplete="off" class="selmen">
			...
			<section id="recipientcase">
				...
				<section id="priority">
					<h3>Address:</h3>
					<input type="text" name="stuPlotno" placeholder="House No./Plot No.." class="selmen">
    				<input type="text" name="stuStreet" placeholder="Street Name.." class="selmen">  
    				<input type="text" name="stuCity" placeholder="City Name.." class="selmen">
    				<input type="text" name="stuPin" placeholder="Pincode.." class="selmen">
				</section>
			</section>
		</div>
